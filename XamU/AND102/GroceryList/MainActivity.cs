...
{
    //https://elearning.xamarin.com/android/and102/1-StartActivity/exercise1/
	...
	public class MainActivity : Activity
	{
        ...
        private const int AddItemActivityResultCode = 100;
		...
		void OnAddItemClick(object sender, EventArgs e)
		{
			...
			//
			StartActivityForResult(intent, AddItemActivityResultCode);
		}
		...
		protected override void OnActivityResult(int requestCode, Result resultCode, Intent data)
		{
			...
			//
			if (requestCode == AddItemActivityResultCode && resultCode == Result.Ok)
			{
        ...
        {
            //base.OnBackPressed();
            Toast.MakeText(this, "Where do you think you're going?", ToastLength.Long).Show();
        }
    }
}