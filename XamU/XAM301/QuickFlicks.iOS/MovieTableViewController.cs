...
namespace QuickFlicks
{
    ...
    //how to do the storyboard stuff:
    //https://elearning.xamarin.com/forms/xam301/1-architect-an-ios-app-in-mvc/exercise1/5-add-tableview
    ...
    public partial class MovieTableViewController : UITableViewController, IUISearchResultsUpdating
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            searchController.SearchBar.Placeholder = "Search Movies - MVC";
